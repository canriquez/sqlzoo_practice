...
00 million is 200000000, there are eight zeros. */
...
at least one trillion (1000000000000; that is 12 zeros). Round this value to the nearest 1000.
Show per-capita GDP for the trillion dollar countries to the nearest $1000. */

SELECT name, ROUND(gdp/population/1000)*1000 AS 'per-capita_GDP'
FROM world
