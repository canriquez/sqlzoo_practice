...
in the game table. We can look up information about game 1012 by finding that row in the game table.
...
3.
You can combine the two steps into a single query
with a JOIN.
...
SELECT goal.player, goal.teamid, eteam.coach, gtime
FROM goal
...
...
Notice in the query given every goal is listed. If it was a team1 goal then 
a 1 appears in score1, otherwise there is a 0. You could SUM this column to get a 
count of the goals scored by team1. 
